...
//"Добро пожаловать в приют для животных г.Астана. " +
//                "Бот-помощник может показать информацию о приютах, расскажет, как взять животное из приюта, " +
//                "примет отчет о питомце. Для начала выберите приют!"
